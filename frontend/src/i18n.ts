...
const translations = {
  en: {
    ...
    'analytics.questionNetwork': 'Question network',
    'analytics.questionNetworkHint': 'Track whether questions stay attached to one investigation thread, which intents dominate, and which frontier topics still need attention.',
    'analytics.connectedRatio': 'Connected ratio',
    'analytics.frontierCount': 'Open frontier',
    'analytics.isolatedQuestions': 'Isolated questions',
    'analytics.repeatOpeningClusters': 'Repeated openings',
    'analytics.topIntents': 'Top intents',
    'analytics.undercoveredIntents': 'Under-covered intents',
    'analytics.topRelationTypes': 'Top relation types',
    'analytics.frontierPreview': 'Frontier preview',
    'analytics.networkDiagnostics': 'Network diagnostics',
  ...
  'zh-CN': {
    ...
    'analytics.questionNetwork': '问题网络',
    'analytics.questionNetworkHint': '观察问题是否持续挂在线索上、哪些开发者意图过度集中，以及哪些前沿主题仍待展开。',
    'analytics.connectedRatio': '连通率',
    'analytics.frontierCount': '待探索前沿',
    'analytics.isolatedQuestions': '孤立问题',
    'analytics.repeatOpeningClusters': '重复开头簇',
    'analytics.topIntents': '高频意图',
    'analytics.undercoveredIntents': '欠覆盖意图',
    'analytics.topRelationTypes': '高频关联类型',
    'analytics.frontierPreview': '前沿预览',
    'analytics.networkDiagnostics': '网络诊断',
